          ...
          <div className="animate-in fade-in duration-700">
            ...
            <section className="relative h-[90vh] flex items-center justify-center overflow-hidden">
              <div className="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?auto=format&fit=crop&q=80&w=2400" className="w-full h-full object-cover opacity-40 scale-105 animate-slow-zoom" alt="Salta Background" />
                <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/20 to-[#050505]" />
              </div>
              <div className="relative z-10 container mx-auto px-6 text-center max-w-5xl">
                <h2 className="text-5xl md:text-8xl font-black mb-12 leading-tight tracking-tighter">Tu próximo hogar <br /><span className="text-orange-600 italic">está en Salta.</span></h2>
          ...
          <div className="pt-32 min-h-screen bg-[#050505] animate-in fade-in duration-500 flex flex-col">
             <div className="container mx-auto px-6 py-12 flex flex-col lg:flex-row gap-12 flex-1">
              <aside className="lg:w-[360px] shrink-0">
                 <div className="sticky top-32 max-h-[calc(100vh-160px)] overflow-y-auto no-scrollbar pr-2">
