  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="bg-[#0f0f0f]/80 backdrop-blur-xl border border-white/10 px-6 py-4 rounded-full shadow-2xl hover:scale-105 transition-all flex items-center gap-3 group"
      >
        ...
        <span className="text-sm font-black uppercase tracking-widest text-white/80">Cotización</span>
      </button>

      {isOpen && (
        <div className="absolute bottom-20 right-0 w-[88vw] md:w-[380px] bg-[#0a0a0a] backdrop-blur-3xl border border-white/10 p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] shadow-3xl animate-in zoom-in-95 duration-300 overflow-hidden">
